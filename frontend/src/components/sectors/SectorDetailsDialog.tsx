...
import { getSectorTypeIcon, getSectorTypeLabel } from "./SectorUtils";
import { SectorTasksTab } from "./SectorTasksTab";
...
export const SectorDetailsDialog = ({ 
  isOpen, 
  onClose, 
  sector 
