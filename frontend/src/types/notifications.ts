...
export const NOTIFICATION_TYPE_MAPPINGS: Record<string, { ui_type: NotificationUIType; display_type: NotificationDisplayType }> = {
  ...
  'task_delegated': { ui_type: 'task', display_type: 'info' },
  'task_finalized': { ui_type: 'task', display_type: 'success' },
  ...
  'link_shared': { ui_type: 'document', display_type: 'info' },
  'link_updated': { ui_type: 'document', display_type: 'info' },
  'report_table_assigned': { ui_type: 'survey', display_type: 'info' },
  'report_table_approved': { ui_type: 'survey', display_type: 'success' },
  'report_table_rejected': { ui_type: 'survey', display_type: 'error' },
  'revision_required': { ui_type: 'survey', display_type: 'warning' },
  'approval_completed': { ui_type: 'survey', display_type: 'success' },
  'attendance_reminder': { ui_type: 'system', display_type: 'warning' },
  'project_assigned': { ui_type: 'task', display_type: 'info' },
  'project_activity_assigned': { ui_type: 'task', display_type: 'info' },
