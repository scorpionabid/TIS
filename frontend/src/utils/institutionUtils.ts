 ...
 */
export const getFallbackTypesForRole = (
  userRole?: string,
): InstitutionType[] => {
  // Debug logging for development
  if (process.env.NODE_ENV === "development") {
    logger.log("getFallbackTypesForRole called", {
      component: "institutionUtils",
      action: "getFallbackTypesForRole",
      data: { userRole, effectiveRole: userRole || "superadmin" },
    });
  }
  ...
  // Map to actual types
  const mappedTypes = accessibleTypes
  ...
  if (process.env.NODE_ENV === "development") {
    logger.log("getFallbackTypesForRole result", {
      ...
      data: {
        ...
        allMappedTypes: mappedTypes.map((t) => ({
          key: t.key,
          level: t.default_level,
          label: t.label_az,
        })),
      },
    });
 ...
 */
export const getInstitutionIcon = (
  type:
    | string
    | { id: number; name: string; key: string; level: number }
    | null,
): React.ReactElement => {
  let typeKey = "";
  ...
  switch (typeKey) {
    case "ministry":
      return React.createElement(Building, { size: 16 });
    case "region":
    case "regional_education_department":
    case "regional":
      return React.createElement(MapPin, { size: 16 });
    case "sektor":
    case "sector":
  ...
  if (typeof type === "string") {
    switch (type) {
      case "ministry":
        return "Nazirlik";
      case "region":
        return "Regional İdarə";
      case "regional_education_department":
        return "Regional Təhsil İdarəsi";
      case "regional":
        return "Regional İdarə";
      case "sektor":
        return "Sektor";
      case "sector":
        return "Sektor";
      case "sector_education_office":
        return "Sektor Təhsil Şöbəsi";
      case "school":
        return "Məktəb";
      case "secondary_school":
        return "Tam orta məktəb";
      case "lyceum":
        return "Lisey";
      case "gymnasium":
        return "Gimnaziya";
      case "kindergarten":
        return "Uşaq Bağçası";
      case "preschool_center":
        return "Məktəbəqədər Təhsil Mərkəzi";
      case "nursery":
        return "Uşaq Evi";
      case "vocational_school":
        return "Peşə Məktəbi";
      case "special_education_school":
        return "Xüsusi Təhsil Məktəbi";
      case "primary_school":
        return "İbtidai məktəb";
      case "vocational":
        return "Peşə məktəbi";
      case "university":
        return "Universitet";
 ...
 */
export const canAccessInstitutionType = (
