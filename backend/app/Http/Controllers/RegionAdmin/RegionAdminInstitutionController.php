...
class RegionAdminInstitutionController extends Controller
{
    ...
    public function getInstitutionStats(Request $request): JsonResponse
    {
        ...
        $sectors = $this->institutionService->getSectorStatistics($userRegionId);
        $summary = $this->institutionService->getSummaryStatistics($sectors);
    ...
    public function getPerformanceInsights(Request $request): JsonResponse
    {
        ...
        $performance = $this->institutionService->calculatePerformanceInsights($userRegionId);
