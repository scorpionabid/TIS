...
class NotificationController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'type' => 'nullable|string|in:task_assigned,task_updated,task_deadline,survey_published,survey_assigned,survey_deadline,survey_approved,survey_rejected,revision_required,approval_completed,system_alert,maintenance,security_alert',
