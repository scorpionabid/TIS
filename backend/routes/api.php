...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // Education Sectors Management
    Route::get('sectors', [SectorController::class, 'index'])->middleware('permission:institutions.read');
    Route::post('sectors', [SectorController::class, 'store'])->middleware(['permission:institutions.create', 'audit.logging']);
    Route::get('sectors/statistics', [SectorController::class, 'statistics'])->middleware('permission:institutions.read');
    Route::get('sectors/managers/available', [SectorController::class, 'getAvailableManagers'])->middleware('permission:institutions.read');
    Route::get('sectors/{sector}', [SectorController::class, 'show'])->middleware('permission:institutions.read');
    Route::put('sectors/{sector}', [SectorController::class, 'update'])->middleware(['permission:institutions.update', 'audit.logging']);
    Route::delete('sectors/{sector}', [SectorController::class, 'destroy'])->middleware(['permission:institutions.delete', 'audit.logging']);
    Route::post('sectors/{sector}/toggle-status', [SectorController::class, 'toggleStatus'])->middleware(['permission:institutions.update', 'audit.logging']);
    
    // Sector task management
    Route::get('sectors/{sector}/tasks', [SectorController::class, 'getTasks'])->middleware('permission:tasks.read');
    Route::post('sectors/{sector}/tasks', [SectorController::class, 'createTask'])->middleware(['permission:tasks.create', 'audit.logging']);
    Route::get('sectors/{sector}/tasks/statistics', [SectorController::class, 'getTaskStatistics'])->middleware('permission:tasks.read');
    
    // Sector document management
    Route::get('sectors/{sector}/documents', [SectorController::class, 'getDocuments'])->middleware('permission:documents.read');
    Route::post('sectors/{sector}/documents', [SectorController::class, 'uploadDocument'])->middleware(['permission:documents.create', 'audit.logging']);
    Route::get('sectors/{sector}/documents/statistics', [SectorController::class, 'getDocumentStatistics'])->middleware('permission:documents.read');
    Route::post('sectors/{sector}/documents/{document}/share', [SectorController::class, 'shareDocument'])->middleware(['permission:documents.share', 'audit.logging']);

    // Preschool management
    Route::get('preschools', [PreschoolController::class, 'index'])->middleware('permission:institutions.read');
    Route::post('preschools', [PreschoolController::class, 'store'])->middleware(['permission:institutions.create', 'audit.logging']);
    Route::get('preschools/statistics', [PreschoolController::class, 'getPreschoolStatistics'])->middleware('permission:institutions.read');
    Route::get('preschools/{preschool}', [PreschoolController::class, 'show'])->middleware('permission:institutions.read');
    Route::put('preschools/{preschool}', [PreschoolController::class, 'update'])->middleware(['permission:institutions.update', 'audit.logging']);
    Route::delete('preschools/{preschool}', [PreschoolController::class, 'destroy'])->middleware(['permission:institutions.delete', 'audit.logging']);
    Route::put('preschools/{preschool}/assign-manager', [PreschoolController::class, 'assignManager'])->middleware(['permission:institutions.update', 'audit.logging']);
    ...
    // School Attendance Management (Simple daily attendance tracking)
    Route::prefix('school-attendance')->group(function () {
        Route::get('/', [SchoolAttendanceController::class, 'index'])->middleware('permission:attendance.read');
        Route::post('/', [SchoolAttendanceController::class, 'store'])->middleware('permission:attendance.create');
        Route::get('/stats', [SchoolAttendanceController::class, 'stats'])->middleware('permission:attendance.read');
        Route::get('/schools/{schoolId}/classes', [SchoolAttendanceController::class, 'getSchoolClasses'])->middleware('permission:attendance.read');
        Route::get('/{schoolAttendance}', [SchoolAttendanceController::class, 'show'])->middleware('permission:attendance.read');
        Route::put('/{schoolAttendance}', [SchoolAttendanceController::class, 'update'])->middleware('permission:attendance.update');
        Route::delete('/{schoolAttendance}', [SchoolAttendanceController::class, 'destroy'])->middleware('permission:attendance.delete');
    });
